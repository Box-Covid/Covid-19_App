...
$('#r_input_img').change(function () {
    $('.img_dashed').html('<img id="blah" class="mg_30" src="" >');
    readURL(this);
 });
$(function () {
    "use strict";
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function () {
        ...
        for (var i = window.location, e = $("ul#sidebarnav a").filter(function () {
                return this.href == i
            }).addClass("active").parent().addClass("active"); e.is("li");) e = e.parent().addClass("in").parent().addClass("active")
    }), $(function () {
